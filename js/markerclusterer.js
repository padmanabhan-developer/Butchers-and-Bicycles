...
function D(a, b) {
    ...
    c.push("background-repeat:no-repeat;");
    c.push("background-position:center;");
    ...
    c.push("cursor:pointer; top:" + b.y + "px; left:" + b.x + "px; color:" + (a.N ? a.N : "white") + "; position:absolute; font-size:" + (a.O ? a.O : 11) + "px; font-family:Arial,sans-serif; font-weight:bold");
    return c.join("")
}
